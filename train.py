...
def train(train_file, test_file, batch_size, epoch_limit, gpu_mode, num_workers, retrain_model, retrain_model_path,
    ...
    encoder_model, decoder_model = ModelHandler.get_new_model(input_channels=10,
                                                              ...
                                                              num_classes=6)
    encoder_optimizer = torch.optim.Adam(encoder_model.parameters(), lr=0.0004301109389456553,
                                         weight_decay=2.8911373673854366e-05)
    decoder_optimizer = torch.optim.Adam(decoder_model.parameters(), lr=3.653594410587846e-05,
                                         weight_decay=0.0001163270305441028)
