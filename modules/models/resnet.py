...
class ResNet(nn.Module):
    ...
    def __init__(self, in_channels, block, layers):
        ...
        self.Context_Conv2d_0a = BasicConv2d(in_channels, 20, kernel_size=3, padding=1)
        self.Context_Conv2d_0b = BasicConv2d(20, 40, kernel_size=3, padding=1, stride=(1, 2))
        self.Context_Conv2d_0c = BasicConv2d(40, 80, kernel_size=3, padding=1)
